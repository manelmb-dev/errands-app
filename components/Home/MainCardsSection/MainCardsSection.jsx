    ...
    <Pressable className="flex-row flex-wrap pb-0.5 justify-between">
      {cards.map((card, index) => {
        ...
        return (
          ...
          >
            <View
              className={`flex-row justify-between bg-[${themes[theme].buttonMenuBackground}] p-3 rounded-2xl w-full h-full  border border-[${themes[theme].listsSeparator}] shadow-sm ${
