...
export default function SharedSection() {
  ...
  return (
    <View
      className={`w-full mt-3 pt-5 bg-[${themes[theme].surfaceBackground}] rounded-t-3xl rounded-b-3xl border border-[${themes[theme].borderColor}] shadow-sm ${theme === "light" ? "shadow-gray-100" : "shadow-neutral-950"}`}
    >
